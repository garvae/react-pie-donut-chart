...
import { TEST_CHART_PROPS_COMMON, TEST_SIZE_CHART_HALF, TEST_SIZE_CHART_HALF_STR } from 'tests/mocks/variables';
...
describe('prop "chartCenterSize"', () => {
  it('generates a round chart center element of provided size', async () => {
    ...
    const { getByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} chartCenterSize={chartCenterSize} />);
