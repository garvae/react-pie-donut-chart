...
import { TEST_CHART_PROPS_COMMON, TEST_PROPS, TEST_SIZE_CHART_HALF_STR } from 'tests/mocks/variables';
...
describe('prop "colors.chartBackground"', () => {
  it('generates a "circle" chart background element with the provided color', async () => {
    ...
    const { getByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} colors={{ chartBackground }} />);
