...
describe('prop "text"', () => {
  it('renders the provided "text"', () => {
    ...
    const { getByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} text={text} />);
  ...
  it('renders the total value of "data" when the "text" prop was not provided and the "chartCenterSize" prop was provided', () => {
    ...
    const { getByTestId } = render(
      <PieDonutChart {...TEST_CHART_PROPS_COMMON} chartCenterSize={TEST_PROPS.chartCenterSize} />
    );
  ...
  it("renders the actual total value of 'data' when the 'text' prop was not provided, and the 'chartCenterSize' and 'gap' props are provided", () => {
    ...
    const { getByTestId } = render(
      <PieDonutChart {...TEST_CHART_PROPS_COMMON} chartCenterSize={TEST_PROPS.chartCenterSize} gap={TEST_PROPS.gap} />
    );
