...
describe('prop "isSelectOnKeyEnterDown"', () => {
  it('disables segment selection on "enter" key press on it', () => {
    ...
    const { getAllByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} isSelectOnKeyEnterDown={false} />);
  ...
  it('enables segment selection on "enter" key press on it', () => {
    ...
    const { getAllByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} isSelectOnKeyEnterDown />);
