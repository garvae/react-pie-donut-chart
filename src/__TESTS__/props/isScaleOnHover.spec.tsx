...
describe('prop "isScaleOnHover"', () => {
  it('disables scale on hover', () => {
    ...
    const { getAllByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} isScaleOnHover={false} />);
  ...
  it('enables scale on hover', () => {
    ...
    const { getAllByTestId } = render(<PieDonutChart {...TEST_CHART_PROPS_COMMON} isScaleOnHover />);
