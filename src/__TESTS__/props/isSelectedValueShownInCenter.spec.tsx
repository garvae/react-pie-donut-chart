...
describe('prop "isSelectedValueShownInCenter"', () => {
  it('disables the display of the value of the selected segment in the center of the chart', () => {
    ...
    const checkIfRenderedTotal = () =>
      getElementFirstChildrenInnerHtml({ element: textForeignObject }) === String(totalDataValue);
  ...
  it('enables to display the selected value of the segment in the center of the chart', () => {
    ...
    const { segmentValue, totalDataValue } = getSegmentParams({
      isFirst: true,
      segment
    });
    ...
    const checkIfRenderedTotal = () =>
      getElementFirstChildrenInnerHtml({ element: textForeignObject }) === String(totalDataValue);
    const checkIfRenderedValue = () =>
      getElementFirstChildrenInnerHtml({ element: textForeignObject }) === String(segmentValue);
